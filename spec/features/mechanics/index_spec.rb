...
RSpec.describe 'the mechanic index' do
  ...
  it 'lists all the mechanics and years of experience' do
    ...
    julio = Mechanic.create(name: 'Julio Venegas', years_experience: 2, mechanic_rides_id: mech_ride_1.id)
    catherine = Mechanic.create(name: 'Catherine Duke', years_experience: 5, mechanic_rides_id: mech_ride_2.id)
    lisa = Mechanic.create(name: 'Lisa Miller', years_experience: 22, mechanic_rides_id: mech_ride_3.id)
