...
ActiveRecord::Schema.define(version: 2021_09_13_163620) do
  ...
  create_table "mechanics", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.bigint "mechanic_rides_id"
    t.index ["mechanic_rides_id"], name: "index_mechanics_on_mechanic_rides_id"
  end
  ...
  create_table "rides", force: :cascade do |t|
    ...
    t.index ["mechanic_rides_id"], name: "index_rides_on_mechanic_rides_id"
  end

  add_foreign_key "mechanic_rides", "mechanics"
  add_foreign_key "mechanic_rides", "rides"
  add_foreign_key "mechanics", "mechanic_rides", column: "mechanic_rides_id"
  add_foreign_key "rides", "amusement_parks"
  add_foreign_key "rides", "mechanic_rides", column: "mechanic_rides_id"
end
